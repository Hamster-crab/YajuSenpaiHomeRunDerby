...
#include <string>
#include <cmath>
#include <glm/glm.hpp> // GLMライブラリのインクルード
...
void mouseMoveCallback(GLFWwindow* window, double xpos, double ypos) {
    ...
    playerX = xpos - 50; // Update according to texture size
}
...
int main() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "野獣先輩のホームランダービー", nullptr, nullptr);
    if (!window) {
